#ifndef __COMBASE_COMBASE_EXCEPTIONS_HPP
#define __COMBASE_COMBASE_EXCEPTIONS_HPP
...
namespace combase {
  ...
  /**
   * @brief Root of the combase exceptions.
   *
   * All the combase exceptions inherit from that root, allowing to
...
#endif // __COMBASE_COMBASE_EXCEPTIONS_HPP
